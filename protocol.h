...
//Increase electricity(可下发可上报)
//Notes:
#define DPID_ADD_ELE 20
//Current current(只上报)
//Notes:
#define DPID_CUR_CURRENT 21
//Current power(只上报)
//Notes:
#define DPID_CUR_POWER 22
//Current voltage(只上报)
//Notes:
#define DPID_CUR_VOLTAGE 23
